...
import '../../Retailer_Api/dashboard/dashboard_retailer_model.dart';
import 'dashboard_model.dart';

class DashboardDistributorApi {
  Future<DashboardModel> getAllDashboard() async {
    final token = await AppPrefrence.getString('token');

    final uri = Uri.parse(
      '$mAPIbaseurl/api/dash/distributor/dashboard',
    );
